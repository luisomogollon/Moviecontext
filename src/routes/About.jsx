        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              This is a practice app to improve my handling of React Context and its features
              </p>
          ...
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              I have used Tailwind Css to build the layout of this application.
              </p>
              <button className="mt-3 text-blue-500 inline-flex items-center">
                <svg
                  fill="none"
          ...
          <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base">
              My name is Luis Michinaux and I thank you for taking a look at this App.
              </p>
              <button className="mt-3 text-blue-500 inline-flex items-center">
                <svg
                  fill="none"
